...
module.exports = {
  ...
  cordovaPublic: resolveApp('cordova_public'),
  cordovaBuild: resolveApp('cordova'),
  appHtml: resolveApp('public/index.html'),
  cordovaHtml: resolveApp('cordova_public/index.html'),
...
if (!reactScriptsLinked && __dirname.indexOf(path.join('packages', 'react-scripts', 'config')) !== -1) {
  module.exports = {
    ...
    cordovaPublic: resolveApp('template/cordova_public'),
    cordovaBuild: resolveApp('../../cordova'),
    appHtml: resolveOwn('template/public/index.html'),
    cordovaHtml: resolveApp('template/cordova_public/index.html'),
