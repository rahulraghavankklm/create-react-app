...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      // The cpexcel is needed in certain special cases, including files generated by
  ...
  plugins: [
    ...
    // file (known as a chunk), consisting of common modules shared between
    // multiple entry points. By separating common modules from bundles,
